...
![3 Layer CNN model used in this project](/resources/3layercnn.jpeg "3 Layer CNN model used in this project")


Layer can be made modular so we are not limited to pre-defined number of layers, so at the final synthesis/ application stage, we can test the proposed CNN model out considering system constraints and etc., By simply arranging the modular layers.


![a modular CNN layer](/resources/cnnlayermodule.jpeg "a modular cnn layer")
...
![a modular systolic array for convolution](/resources/systolicarray.jpeg "a modular systolic array for convolution")
...
![Maxpooling module Windowless](/resources/maxpooler.jpeg "Maxpooling Module Windowless")
